...
print("For a: Compairng syn to nonsyn. Wilcox test greater")
print(wilcox.test(syna, nonsyna, alternative='greater'))
print("For a: Compairng CpG to no CpG. Wilcox test less")
...
print("For t: Compairng syn to nonsyn. Wilcox test greater")
print(wilcox.test(synt, nonsynt, alternative='greater'))
print("For t: Compairng CpG to no CpG. Wilcox test less")
...
print("For c: Compairng syn to nonsyn. Wilcox test greater")
...
print("For g: Compairng syn to nonsyn. Wilcox test greater")
