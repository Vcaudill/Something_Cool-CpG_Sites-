...
my.list <- list(EnterovirusA_VP1, EnterovirusB_VP1, EnterovirusC_VP1, EnterovirusD_VP1, BK_polyomavirus_VP1, HumanBocavirus1_VP1, EnterovirusA_VP2, EnterovirusB_VP2, EnterovirusC_VP2, HumanBocavirus1_NS1, humanparainfluenzavirus1_F, humanparainfluenzavirus1_HN, humanparainfluenzavirus3_HN, InfluenzaAvirus_HA_H1N1, InfluenzaAvirus_HA_H3N2, InfluenzaBvirus_HA, InfluenzaAvirus_NA_H1N1, InfluenzaAvirus_NA_H3N2, InfluenzaBvirus_NA, DengueVirus1, DengueVirus2, DengueVirus3, DengueVirus4)
