...
DengueVirus1 <- read.csv("data/data_2019/Csv/DengueVirus1.CSV")
BKpolyomavirus_VP1<-read.csv("data/data_2019/Csv/new_for_costly/BKpolyomavirus_VP1.CSV")
DengueVirus2<- read.csv("data/data_2019/Csv/DengueVirus2.CSV")
DengueVirus3<-read.csv("data/data_2019/Csv/DengueVirus3.CSV")
DengueVirus4<-read.csv("data/data_2019/Csv/DengueVirus4.CSV")
EnterovirusA_VP1<-read.csv("data/data_2019/Csv/EnterovirusA_VP1_EVA71.CSV")
EnterovirusA_VP2<-read.csv("data/data_2019/Csv/EnterovirusA_VP2_EVA71.CSV")
EnterovirusB_VP1<-read.csv("data/data_2019/Csv/EnterovirusB_VP1_Echovirus30.CSV")
EnterovirusB_VP2<-read.csv("data/data_2019/Csv/new_for_costly/EnterovirusB_VP2.CSV")
EnterovirusC_VP1<-read.csv("data/data_2019/Csv/EnterovirusC_VP1_Polio2.CSV")
EnterovirusC_VP2<-read.csv("data/data_2019/Csv/Enterovirus_C_VP2_Polio2.CSV")
EnterovirusD_VP1<-read.csv("data/data_2019/Csv/EnteroD68_VP1.CSV")
HepatitisCvirus_1A<- read.csv("data/data_2019/Csv/new_for_costly/HCV1A.CSV")
HepatitisCvirus_1B<- read.csv("data/data_2019/Csv/HCV1B_CDS_alignment.CSV")
HIV_1<- read.csv("data/data_2019/Csv/new_for_costly/HIV1_FLT_2017_pol_DNA.CSV")
#HumanBocavirus1_NS1<-read.csv("data/csv/HumanBocavirus1_NS1.CSV")
HumanBocavirus1_VP1<-read.csv("data/data_2019/Csv/HumanBoca_VP1.CSV")
humanparainfluenzavirus1_F<-read.csv("data/data_2019/Csv/humanparainfluenza1_F.CSV")
humanparainfluenzavirus1_HN<-read.csv("data/data_2019/Csv/new_for_costly/humanparainfluenzavirus1_HN.CSV")
humanparainfluenzavirus3_HN<-read.csv("data/data_2019/Csv/humanparainfluenza3_HN.CSV")
humanparainfluenzavirus1<-read.csv("data/NESCENT_data/csv/humanparainfluenzavirus1.csv")
humanparainfluenzavirus3<-read.csv("data/NESCENT_data/csv/humanparainfluenzavirus3.csv")
InfluenzaAvirus_HA_H1N1<-read.csv("data/data_2019/Csv/InfluenzaAvirus_HA_H1N1_alignment.CSV")
InfluenzaAvirus_HA_H3N2<-read.csv("data/data_2019/Csv/InfluenzaAvirus_HA_H3N2_alignment.CSV")
InfluenzaAvirus_NA_H1N1<-read.csv("data/data_2019/Csv/InfluenzaAvirus_NA_H1N1_alignment.CSV")
InfluenzaAvirus_NA_H3N2<-read.csv("data/data_2019/Csv/InfluenzaAvirus_NA_H3N2_alignment.CSV")
InfluenzaBvirus_NA<-read.csv("data/data_2019/Csv/InfluenzaB_NA.CSV")
InfluenzaBvirus_HA<-read.csv("data/data_2019/Csv/InfluenzaB_HA.CSV")



HepatitisB_polymerase<-read.csv('data/data_2019/Csv/HepatitisB_polymerase.csv')
HepatitisB_precore<-read.csv("data/data_2019/Csv/HepatitisB_precore.csv")
HepatitisB_polymerase_truncated_precore<- read.csv("data/NESCENT_data/csv/HepatitisB_polymerase_truncated_precore.csv")
HepatitisB_s<-read.csv('data/data_2019/Csv/HepatitisB_s.csv')
HepatitisB_pre_S<-read.csv('data/data_2019/Csv/HepatitisB_preS.csv')
HepatitisB_core<-read.csv("data/data_2019/Csv/HepatitisB_core.csv")

Humanherpesvirus2_glycoprotein_G<-read.csv("data/data_2019/Csv/Humanherpesvirus2_G.csv")
#Humanpapillomavirus16<-read.csv("data/csv/Humanpapillomavirus16.csv")
Humanpapillomavirus16_L1<-read.csv("data/data_2019/Csv/Humanpapilloma16_L1.csv")
Humanrespiratorysyncytialvirus<-read.csv("data/NESCENT_data/csv/Humanrespiratorysyncytialvirus.csv") 
Humanrespiratorysyncytialvirus_G<-read.csv("data/data_2019/Csv/Humanrespiratorysyncytialvirus_G.csv")
# JCpolyomavirus_VP1<-read.csv("data/csv/JCpolyomavirus_VP1.csv")
# Measles<-read.csv("data/csv/Measles.csv")
Measles_hemagglutinin_OR_haemagglutinin<-read.csv("data/data_2019/Csv/Measles_hemagglutinin_alignment.csv") 
ParvovirusB19_NS1<-read.csv("data/data_2019/Csv/ParovirusB19_NS1_alignment.csv")
ParvovirusB19_VP1<-read.csv("data/data_2019/Csv/Parovovirus_B19_VP1_alignment.csv") 
RhinovirusB<-read.csv("data/data_2019/Csv/RhinovirusB alignment.csv") 
#RhinovirusB_polyprotein<-read.csv("data/csv/RhinovirusB_polyprotein.csv")
RhinovirusC<-read.csv("data/NESCENT_data/csv/RhinovirusC.csv")
RotavirusA_VP6<-read.csv("data/data_2019/Csv/RotavirusA_VP6_alignment.csv")
...
# graphing 
png("output/Costly/Costly_Graph_AllR_6_19.png", width = 15, height = 8, units = "in", res= 500)
#--------------------
...
plot(x,y, type = "n", log ='y' ,main="Cost of CpG-Creating Mutations", xlab=" ", yaxt = "n", ylab="Costly", xaxt = "n", ylim=c(0.1, 500), xlim=c(1.5, length(my.list) +5.5), las= 1, cex.main=3) 
...
# xlab="Virus "
text(47, 3, " CpG Mutation \n More Costly", cex = 1, font = 2)
text(44.5, 3, "↑", cex = 3, font = 2)
