...
comparing_CpG_Syn_Nonsyn_new = function(truename,nice_name){
  ...
  for (i in 1:length(AllA$makesCpG)) {
    if (AllA$makesCpG[i] == 1 && AllA$TypeOfSite[i] == "syn") {
      AllA$graphit[i] <- 2
      AllA$median_value[i] <- median(AllA$Freq[(which(AllA$makesCpG == 1 & AllA$TypeOfSite == "syn") )])
      AllA$sd_vals[i]<-sd(AllA$Freq[(which(AllA$makesCpG == 1 & AllA$TypeOfSite == "syn") )])
    }
    if (AllA$makesCpG[i] == 1 && AllA$TypeOfSite[i] == "nonsyn") {
      AllA$graphit[i] <- 4
      AllA$median_value[i] <- median(AllA$Freq[(which(AllA$makesCpG == 1 & AllA$TypeOfSite == "nonsyn") )])
      AllA$sd_vals[i]<-sd(AllA$Freq[(which(AllA$makesCpG == 1 & AllA$TypeOfSite == "nonsyn") )])
    }
    if (AllA$makesCpG[i] == 0 && AllA$TypeOfSite[i] == "syn") {
      AllA$graphit[i] <- 1
      AllA$median_value[i] <- median(AllA$Freq[(which(AllA$makesCpG == 0 & AllA$TypeOfSite == "syn") )])
      AllA$sd_vals[i]<-sd(AllA$Freq[(which(AllA$makesCpG == 0 & AllA$TypeOfSite == "syn") )])
    }
    if (AllA$makesCpG[i] == 0 && AllA$TypeOfSite[i] == "nonsyn") {
      AllA$graphit[i] <- 3
      AllA$median_value[i] <- median(AllA$Freq[(which(AllA$makesCpG == 0 & AllA$TypeOfSite == "nonsyn") )])
      AllA$sd_vals[i]<-sd(AllA$Freq[(which(AllA$makesCpG == 0 & AllA$TypeOfSite == "nonsyn") )])
    }
  }
  ...
  for (i in 1:length(AllT$makesCpG)) {
    if (AllT$makesCpG[i] == 1 && AllT$TypeOfSite[i] == "syn") {
      AllT$graphit[i] <- 2
      AllT$median_value[i] <- median(AllT$Freq[(which(AllT$makesCpG == 1 & AllT$TypeOfSite == "syn") )])
      AllT$sd_vals[i]<-sd(AllT$Freq[(which(AllT$makesCpG == 1 & AllT$TypeOfSite == "syn") )])
    }
    if (AllT$makesCpG[i] == 1 && AllT$TypeOfSite[i] == "nonsyn") {
      AllT$graphit[i] <- 4
      AllT$median_value[i] <- median(AllT$Freq[(which(AllT$makesCpG == 1 & AllT$TypeOfSite == "nonsyn") )])
      AllT$sd_vals[i]<-sd(AllT$Freq[(which(AllT$makesCpG == 1 & AllT$TypeOfSite == "nonsyn") )])
    }
    if (AllT$makesCpG[i] == 0 && AllT$TypeOfSite[i] == "syn") {
      AllT$graphit[i] <- 1
      AllT$median_value[i] <- median(AllT$Freq[(which(AllT$makesCpG == 0 & AllT$TypeOfSite == "syn") )])
      AllT$sd_vals[i]<-sd(AllT$Freq[(which(AllT$makesCpG == 0 & AllT$TypeOfSite == "syn") )])
    }
    if (AllT$makesCpG[i] == 0 && AllT$TypeOfSite[i] == "nonsyn") {
      AllT$graphit[i] <- 3
      AllT$median_value[i] <- median(AllT$Freq[(which(AllT$makesCpG == 0 & AllT$TypeOfSite == "nonsyn") )])
      AllT$sd_vals[i]<-sd(AllT$Freq[(which(AllT$makesCpG == 0 & AllT$TypeOfSite == "nonsyn") )])
    }
  }
  ...
  for (i in 1:length(AllC$makesCpG)) {
    ...
    if (AllC$makesCpG[i] == 0 && AllC$TypeOfSite[i] == "syn") {
      AllC$graphit[i] <- 1
      AllC$median_value[i] <- median(AllC$Freq[(which(AllC$makesCpG == 0 & AllC$TypeOfSite == "syn") )])
      AllC$sd_vals[i]<-sd(AllC$Freq[(which(AllC$makesCpG == 0 & AllC$TypeOfSite == "syn") )])
    }
    if (AllC$makesCpG[i] == 0 && AllC$TypeOfSite[i] != "syn") {
      AllC$graphit[i] <- 3
      AllC$median_value[i] <- median(AllC$Freq[(which(AllC$makesCpG == 0 & AllC$TypeOfSite == "nonsyn") )])
      AllC$sd_vals[i]<-sd(AllC$Freq[(which(AllC$makesCpG == 0 & AllC$TypeOfSite == "nonsyn") )])
    }
  }
  ...
  for (i in 1:length(AllG$makesCpG)) {
    ...
    if (AllG$makesCpG[i] == 0 && AllG$TypeOfSite[i] == "syn") {
      AllG$graphit[i] <- 1
      AllG$median_value[i] <- median(AllG$Freq[(which(AllG$makesCpG == 0 & AllG$TypeOfSite == "syn") )])
      AllG$sd_vals[i]<-sd(AllG$Freq[(which(AllG$makesCpG == 0 & AllG$TypeOfSite == "syn") )])
    }
    if (AllG$makesCpG[i] == 0 && AllG$TypeOfSite[i] != "syn") {
      AllG$graphit[i] <- 3
      AllG$median_value[i] <- median(AllG$Freq[(which(AllG$makesCpG == 0 & AllG$TypeOfSite == "nonsyn") )])
      AllG$sd_vals[i]<-sd(AllG$Freq[(which(AllG$makesCpG == 0 & AllG$TypeOfSite == "nonsyn") )])
    }
  }
  
  AllA$LCLS = AllA$median_value - AllA$sd_vals
  AllA$UCLS = AllA$median_value + AllA$sd_vals
  
  AllT$LCLS = AllT$median_value - AllT$sd_vals
  AllT$UCLS = AllT$median_value + AllT$sd_vals
  
  AllC$LCLS = AllC$median_value - AllC$sd_vals
  AllC$UCLS = AllC$median_value + AllC$sd_vals
  
  AllG$LCLS = AllG$median_value - AllG$sd_vals
  AllG$UCLS = AllG$median_value + AllG$sd_vals
  ####################################################################################
