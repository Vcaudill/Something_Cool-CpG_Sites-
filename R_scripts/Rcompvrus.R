...
DengueVirus1 <- read.csv("new_data/Consensus/DengueVirus1.CSV")
BKpolyomavirus_VP1<-read.csv("new_data/Consensus/new_for_costly/BKpolyomavirus_VP1.CSV")
DengueVirus2<- read.csv("new_data/Consensus/DengueVirus2.CSV")
DengueVirus3<-read.csv("new_data/Consensus/DengueVirus3.CSV")
DengueVirus4<-read.csv("new_data/Consensus/DengueVirus4.CSV")
EnterovirusA_VP1<-read.csv("new_data/Consensus/EnterovirusA_VP1_EVA71.CSV")
EnterovirusA_VP2<-read.csv("new_data/Consensus/EnterovirusA_VP2_EVA71.CSV")
EnterovirusB_VP1<-read.csv("new_data/Consensus/EnterovirusB_VP1_Echovirus30.CSV")
EnterovirusB_VP2<-read.csv("new_data/Consensus/new_for_costly/EnterovirusB_VP2.CSV")
EnterovirusC_VP1<-read.csv("new_data/Consensus/EnterovirusC_VP1_Polio2.CSV")
EnterovirusC_VP2<-read.csv("new_data/Consensus/Enterovirus_C_VP2_Polio2.CSV")
EnterovirusD_VP1<-read.csv("new_data/Consensus/EnteroD68_VP1.CSV")
HepatitisCvirus_1A<- read.csv("new_data/Consensus/new_for_costly/HCV1A.CSV")
HepatitisCvirus_1B<- read.csv("data/csv/HCV1B_CDS_alignment.CSV")
HIV_1<- read.csv("new_data/Consensus/new_for_costly/HIV1_FLT_2017_pol_DNA.CSV")
#HumanBocavirus1_NS1<-read.csv("data/csv/HumanBocavirus1_NS1.CSV")
HumanBocavirus1_VP1<-read.csv("new_data/Consensus/HumanBoca_VP1.CSV")
humanparainfluenzavirus1_F<-read.csv("new_data/Consensus/humanparainfluenza1_F.CSV")
humanparainfluenzavirus1_HN<-read.csv("new_data/Consensus/new_for_costly/humanparainfluenzavirus1_HN.CSV")
humanparainfluenzavirus3_HN<-read.csv("new_data/Consensus/humanparainfluenza3_HN.CSV")
...
HepatitisB_polymerase<-read.csv('new_data/Consensus/HepatitisB_polymerase.csv')
HepatitisB_precore<-read.csv("new_data/Consensus/HepatitisB_precore.csv")
HepatitisB_polymerase_truncated_precore<- read.csv("data/csv/HepatitisB_polymerase_truncated_precore.csv")
HepatitisB_s<-read.csv('new_data/Consensus/HepatitisB_s.csv')
HepatitisB_pre_S<-read.csv('new_data/Consensus/HepatitisB_preS.csv')
HepatitisB_core<-read.csv("new_data/Consensus/HepatitisB_core.csv")

Humanherpesvirus2_glycoprotein_G<-read.csv("new_data/Consensus/Humanherpesvirus2_G.csv")
#Humanpapillomavirus16<-read.csv("data/csv/Humanpapillomavirus16.csv")
Humanpapillomavirus16_L1<-read.csv("new_data/Consensus/Humanpapilloma16_L1.csv")
Humanrespiratorysyncytialvirus<-read.csv("data/csv/Humanrespiratorysyncytialvirus.csv") 
Humanrespiratorysyncytialvirus_G<-read.csv("new_data/Consensus/Humanrespiratorysyncytialvirus_G.csv")
# JCpolyomavirus_VP1<-read.csv("data/csv/JCpolyomavirus_VP1.csv")
# Measles<-read.csv("data/csv/Measles.csv")
Measles_hemagglutinin_OR_haemagglutinin<-read.csv("new_data/Consensus/Measles_hemagglutinin_alignment.csv") 
ParvovirusB19_NS1<-read.csv("new_data/Consensus/ParovirusB19_NS1_alignment.csv")
ParvovirusB19_VP1<-read.csv("new_data/Consensus/Parovovirus_B19_VP1_alignment.csv") 
RhinovirusB<-read.csv("new_data/Consensus/RhinovirusB alignment.csv") 
#RhinovirusB_polyprotein<-read.csv("data/csv/RhinovirusB_polyprotein.csv")
RhinovirusC<-read.csv("data/csv/RhinovirusC.csv")
RotavirusA_VP6<-read.csv("new_data/Consensus/RotavirusA_VP6_alignment.csv")
